...
submitButton1.onclick = () => {
  ...
  function score1(numberInput1){
     if(numberInput1>=0 && numberInput1<=19){
  ...
  console.log(score1(numberInput1));
...
submitButton2.onclick = () => {
  ...
  console.log(score2(numberInput2));
